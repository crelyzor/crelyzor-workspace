...
**Phase 6 — Teams** ← current

Phases 1 → 3.4 complete ✅. Phase 4.1–4.9 complete ✅. Phase 5 complete ✅. Phase 7 (Razorpay) blocked ⛔. Phase 8 (Big Brain) blocked ⛔.

**Upcoming phase order:**
- **Phase 5** — Encryption at Rest ✅ complete
- **Phase 6** — Teams (design: `docs/internal/superpowers/specs/2026-05-09-teams-design.md`) ← current
