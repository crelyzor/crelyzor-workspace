...
4. Once the plan is written, run the appropriate reviewers in parallel:
...
After execution, run post-build steps automatically:
- If a new backend endpoint was built → generate test commands:
  ```
  API TEST COMMANDS
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  curl:
  ...
  Body (raw JSON): [sample payload]
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ```
- If both backend + frontend were changed in the same task → invoke `crelyzor-reviewer` to check for type drift between backend response shapes and frontend service types.
